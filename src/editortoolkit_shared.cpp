...
bool EditorToolkitShared::InsertSchenkerLabel(const std::string &noteId, const std::string &text)
{
    ...
    // Runtime upper/lower must use actual Staff object drawing order on the
    // page. Do not use staff@n: both CF-005 staves may have n="1", and each
    // neon-neume-line measure contains only one staff.
